...
function OnboardingTab({ tasks }: { tasks?: ApiOnBoardingTask[] }) {
  return (
    <div className="bg-gradient-to-br rounded-2xl p-10 max-w-xl mt-4 bg-white shadow-md  mx-auto">
      <h2 className="text-3xl font-extrabold mb-8 text-primary  tracking-tight ">
        Onboarding Steps
      </h2>
      <div>
